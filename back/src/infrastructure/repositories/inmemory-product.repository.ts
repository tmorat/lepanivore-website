...
export class InMemoryProductRepository implements ProductRepository {
  async findAll(): Promise<ProductInterface[]> {
    return [
      ...
      {
        id: 2,
        name: 'La Miche Rustique, cuite sur pierre naturelle',
        description: 'farine de blé tamisée',
        price: 5.1,
      },
      { id: 3, name: 'Le Mariko', description: "farine de blé tamisée, écorces d'orange bio confites", price: 7.6 },
      {
        id: 4,
        name: 'Le Mariko Choco',
        description: "farine de blé tamisée, écorces d'orange bio confites et pépites de chocolat",
        price: 8.25,
      },
      {
        id: 5,
        name: 'Le Brasseur',
        description: 'farine de blé tamisée, orge malté qui a servi à brasser des bières',
        price: 6.7,
      },
